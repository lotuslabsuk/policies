...
This agreement is made between Lotus Labs Ltd t/a Lotus Labs, a limited company registered in England and Wales with company number 13581885, with the registered office 124 City Road, London, United Kingdom, EC1V 2NX ("Lotus Labs" which expression shall include all or any of its subsidiaries, agents, successors and assigns), and you the customer ("Customer" which expression shall include its permitted successors and assigns).
...
Should we feel that your needs would be better served by another provider, we reserve the right, at our sole discretion, to terminate the hosting agreement. Where it is reasonable to do so, we will provide 30 days notice of termination and a backup of all website content and email.
...
We will always register, transfer and renew domain names in our client's name - never in our own. You are always in control of every aspect of your domain name(s) and can manage your domain's WHOIS data through Lotus Labs.com. It is your responsibility to keep this data correct.

All domain registrations are bound by our Registrant Agreement ([https://lotuslabs.co.uk/terms-of-service#domain-registrant-agreement](https://lotuslabs.co.uk/terms-of-service#domain-registrant-agreement)) and relevant 3rd Party terms as detailed here ([https://lotuslabs.co.uk/terms-of-service#third-party-domain-terms](https://lotuslabs.co.uk/terms-of-service#third-party-domain-terms)).
